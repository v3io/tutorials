...
> **Note:** Some of the demos in the MLRun repo are work in progress
...
<a id="user-segmentation"></a>
# Real Time User Segmentation
The [**Real Time User Segmentation**](slots-stream/real-time-user-segmentation.ipynb) demonstrates how to build a streaming complex event processing on a sliding time window for <br>
